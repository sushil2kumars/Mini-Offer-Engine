...
class DjangoHtmxDebugMixin:
    """
    Use this mixin alongside `DjangoHtmxActionMixin` to help simulate server
    ...
    e.g.:
        class TodoListDemoView(DjangoHtmxDebugMixin, DjangoHtmxActionMixin, BasePageView):
            ...

    Remember: Order matters when using mixins. make sure `DjangoHtmxDebugMixin` appears first
